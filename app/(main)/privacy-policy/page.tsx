  ...
  return (
    <article className="mx-auto max-w-4xl space-y-10 min-h-screen bg-background px-4 py-12 md:px-8 lg:px-16 rounded-lg">
      ...
      <section className="space-y-4 text-sm leading-7">
        <p>
          تُدير <strong>Elena Store (ايلينا ستور)</strong> هذا المتجر والموقع
          الإلكتروني، بما في ذلك جميع المعلومات والمحتويات والميزات والأدوات
          والمنتجات والخدمات المرتبطة، بهدف توفير تجربة تسوق آمنة وسلسة لك كعميل
          (&quot;الخدمات&quot;).
        </p>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7">
        ...
        <p>
          قد يحتوي موقع Elena Store على روابط لمواقع أو خدمات خارجية. لسنا
